const coursesDataMock = [
  {
    id: 1,
    title: "Técnicas Avançadas de Vendas",
    description:
      "Aprenda estratégias comprovadas para aumentar suas vendas e construir relacionamentos duradouros com clientes. Aborda desde prospecção até fechamento.",
    icon: "📈",
    image:
  ...
  },
  {
    ...
    description:
      "Desenvolva habilidades essenciais para proporcionar experiências memoráveis aos clientes e transformá-los em promotores da marca.",
    icon: "💬",
    image:
  ...
  },
  {
    ...
    description:
      "Torne-se um líder inspirador! Aprenda técnicas de gestão, motivação e desenvolvimento de equipes de alto desempenho.",
    icon: "🎯",
    image:
    ...
    lessons: [
      ...
      {
        id: 3,
        title: "Comunicação na Liderança",
        duration: "35 min",
        completed: true,
      },
      {
  ...
  },
  {
    ...
    description:
      "Domine as técnicas de negociação para alcançar acordos vantajosos. Aprenda a preparar, conduzir e fechar negociações com sucesso.",
    icon: "🤝",
    image:
      "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=800&h=400&fit=crop",
    totalLessons: 7,
    completedLessons: 4,
    status: "in-progress",
    points: 180,
    ...
    lessons: [
      ...
      {
        id: 5,
        title: "Superando Impasses",
        duration: "35 min",
        completed: false,
      },
      {
        id: 6,
        title: "Fechamento de Acordos",
        duration: "25 min",
        completed: false,
      },
      {
  ...
  },
  {
    ...
    description:
      "Potencialize suas vendas com estratégias de marketing digital. Aprenda sobre redes sociais, conteúdo e geração de leads online.",
    icon: "📱",
    image:
    ...
    lessons: [
      ...
      {
        id: 2,
        title: "Estratégias em Redes Sociais",
        duration: "35 min",
        completed: true,
      },
      {
  ...
  },
  {
    ...
    description:
      "Aprenda a gerenciar seu tempo de forma eficiente, estabelecer prioridades e aumentar sua produtividade no dia a dia.",
    icon: "⏰",
    image:
    ...
    lessons: [
      {
        id: 1,
        title: "Princípios da Produtividade",
        duration: "25 min",
        completed: false,
      },
      {
      ...
      {
        id: 5,
        title: "Hábitos de Produtividade",
        duration: "30 min",
        completed: false,
      },
    ],
  },
  {
    ...
    description:
      "Desenvolva sua inteligência emocional para melhorar relacionamentos, tomar melhores decisões e gerenciar o estresse.",
    icon: "🧠",
    image:
  ...
  },
  {
    ...
    description:
      "Crie e conduza apresentações que cativam e convencem. Aprenda storytelling, design de slides e técnicas de oratória.",
    icon: "🎤",
    image:
    ...
    lessons: [
      {
        id: 1,
        title: "Estrutura de Apresentações",
        duration: "25 min",
        completed: false,
      },
      {
        id: 2,
        title: "Storytelling Efetivo",
        duration: "35 min",
        completed: false,
      },
      {
      ...
      {
        id: 6,
        title: "Lidando com o Nervosismo",
        duration: "25 min",
        completed: false,
      },
      {
...
let currentCourses = [...coursesDataMock];
...
function createCourseCard(course) {
  ...
  card.innerHTML = `
    ...
    course.title
  }" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22800%22 height=%22400%22%3E%3Crect fill=%22%23667eea%22 width=%22800%22 height=%22400%22/%3E%3C/svg%3E'">
        ...
        <div class="course-content">
            ...
            <div class="course-progress-section">
                ...
                <div class="course-progress-text">
                    <span>${course.completedLessons} de ${
    course.totalLessons
  } aulas</span>
            ...
            <div class="course-footer">
                <span class="lessons-info">${course.duration} • ${
    course.totalLessons
  } aulas</span>
                ${
                  course.status === "completed"
                    ...
                    <div class="completion-info">
                        <div class="completion-date">${formatDate(
...
function openModal(course) {
  ...
  const modalCompletionPoints = document.getElementById(
    "modalCompletionPoints"
  );
  ...
  modalImg.onerror = () => {
    modalImg.src =
      "data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22800%22 height=%22400%22%3E%3Crect fill=%22%23667eea%22 width=%22800%22 height=%22400%22/%3E%3C/svg%3E";
  };
  ...
  course.lessons.forEach((lesson, index) => {
    ...
    lessonItem.innerHTML = `
            ...
            <div class="lesson-status ${
              lesson.completed ? "lesson-completed" : "lesson-current"
            }">
                ${
                  lesson.completed
                    ? "✓ Concluída"
  ...
  if (course.status === "completed") {
    ...
    modalCompletionDate.textContent = `Concluído em ${formatDate(
      course.completionDate
    )}`;
...
function updateStats() {
  const completed = coursesDataMock.filter(
    (c) => c.status === "completed"
  ).length;
  const inProgress = coursesDataMock.filter(
    (c) => c.status === "in-progress"
  ).length;
  const total = coursesDataMock.length;

  const totalLessons = coursesDataMock.reduce(
    (sum, course) => sum + course.totalLessons,
    0
  );
  const completedLessons = coursesDataMock.reduce(
  ...
  if (totalLessonsElement)
    animateCounter(totalLessonsElement, 0, totalLessons, 1000);
  if (completedLessonsElement)
    animateCounter(completedLessonsElement, 0, completedLessons, 1000);
  if (remainingLessonsElement)
    animateCounter(remainingLessonsElement, 0, remainingLessons, 1000);
}
...
function getCoursesByStatus(status) {
  return coursesDataMock.filter((course) => course.status === status);
}

function getCoursesByCategory(category) {
  return coursesDataMock.filter((course) => course.category === category);
}

function getTotalCompletedLessons() {
  return coursesDataMock.reduce(
    (sum, course) => sum + course.completedLessons,
    0
  );
}
...
function startCourse(courseId) {
  const course = coursesDataMock.find((c) => c.id === courseId);
  if (!course) return;
